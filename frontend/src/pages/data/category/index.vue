      ...
      <div>
        <a-row gutter="12">
          ...
          <a-col style="float: right;">
            <a-button type="primary" icon="plus" @click="openFormModal({})">新增分类</a-button>
          </a-col>
        </a-row>
      </div>
        ...
        >
          <div slot="expandedRowRender" slot-scope="item" style="background-color: #fff;">
            <a-table
              ...
              size="small"
              :columns="tableColumns"
              :data-source="item.sub_category_items"
              :pagination="false"
            >
...
import { categoryList, categoryDestroy } from "@/api/data";
  ...
  data() {
    return {
      ...
      tableColumns: [
        ...
        {
          title: "折旧年限",
          dataIndex: "depreciation_life",
          key: "depreciation_life",
        },
        {
          title: "使用年限",
