...
public class MyDividerDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public MyDividerDecoration(Context context, int orientation, int drawableId) {
     ...
     */
    public MyDividerDecoration(Context context, int orientation, int dividerHeight, int dividerColor) {
        this(context, orientation);
    ...
    public MyDividerDecoration(Context context) {
        ...
        mDividerHeight = 2;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(context.getResources().getColor(R.color.cdef));
        mPaint.setStyle(Paint.Style.FILL);
    }
    //获取分割线尺寸
    @Override
